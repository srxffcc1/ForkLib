...
public class LinearLayoutManager extends BaseLayoutManager {
    private static final String LOGTAG = "LinearLayoutManager";

    public LinearLayoutManager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearLayoutManager(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public LinearLayoutManager(Context context, Orientation orientation) {
        super(orientation);
    }
