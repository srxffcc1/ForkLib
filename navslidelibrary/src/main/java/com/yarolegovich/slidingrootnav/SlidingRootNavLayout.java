...
public class SlidingRootNavLayout extends FrameLayout implements SlidingRootNav {
    ...
    public void setMenuview(View menuview) {
        ...
        this.menuview.setLayoutParams(new FrameLayout.LayoutParams(maxDragDistance, ViewGroup.LayoutParams.MATCH_PARENT));
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (child == rootView) {
                ...
                child.layout(left-right, top, right-right, bottom);
            }
        }
    }
    ...
    public void setMenuTransformation(MenuTransformation transformation) {
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            rootTransformation.transform(dragProgress, rootView);
            menuTransformation.transform(dragProgress*menuview.getWidth(),menuview);
//            menuview.setTranslationX(dragProgress*menuview.getWidth());
            notifyDrag();
            invalidate();
        }
