...
public class LibraryActivity extends ListActivity
{
	...
	protected void updateFileList() {
		...
		if (!isExternalStorageReadable()) {
			setTitle(com.example.app.R.string.app_name);
			adapter.add(new Item(topDirectory, getString(com.example.app.R.string.library_no_external_storage)));
			return;
		}

		if (!currentDirectory.isDirectory()) {
			setTitle(com.example.app.R.string.app_name);
			adapter.add(new Item(topDirectory, getString(com.example.app.R.string.library_not_a_directory)));
			return;
		}
		...
		if (files == null)
			adapter.add(new Item(topDirectory, getString(com.example.app.R.string.library_permission_denied)));
		else
			for (File file : files)
