...
public class DocumentActivity extends Activity implements PageView.PageActionListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.app.R.layout.document_activity);
		actionBar = findViewById(com.example.app.R.id.action_bar);
		navigationBar = findViewById(com.example.app.R.id.navigation_bar);
		...
		try {
			...
			if(path==null||"".equals(path)){
				path=new File(Environment.getExternalStorageDirectory()+"/test2017.pdf").getAbsolutePath();
			}
			e.printStackTrace();
		}

		title = path.substring(path.lastIndexOf('/') + 1);
		titleLabel = (TextView)findViewById(com.example.app.R.id.title_label);
		...
		pageView = (PageView)findViewById(com.example.app.R.id.page_view);
		pageView.setActionListener(this);

		pageLabel = (TextView)findViewById(com.example.app.R.id.page_label);
		pageSeekbar = (SeekBar)findViewById(com.example.app.R.id.page_seekbar);
		...
		outlineButton = (View)findViewById(com.example.app.R.id.outline_button);
		...
		layoutButton = (View)findViewById(com.example.app.R.id.layout_button);
		layoutPopupMenu = new PopupMenu(this, layoutButton);
		layoutPopupMenu.getMenuInflater().inflate(com.example.app.R.menu.layout_menu, layoutPopupMenu.getMenu());
		layoutPopupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
			public boolean onMenuItemClick(MenuItem item) {
				float oldLayoutEm = layoutEm;
				int i = item.getItemId();
				if (i == com.example.app.R.id.action_layout_6pt) {
					layoutEm = 6;
				} else if (i == com.example.app.R.id.action_layout_7pt) {
					layoutEm = 7;
				} else if (i == com.example.app.R.id.action_layout_8pt) {
					layoutEm = 8;
				} else if (i == com.example.app.R.id.action_layout_9pt) {
					layoutEm = 9;
				} else if (i == com.example.app.R.id.action_layout_10pt) {
					layoutEm = 10;
				} else if (i == com.example.app.R.id.action_layout_11pt) {
					layoutEm = 11;
				} else if (i == com.example.app.R.id.action_layout_12pt) {
					layoutEm = 12;
				} else if (i == com.example.app.R.id.action_layout_13pt) {
					layoutEm = 13;
				} else if (i == com.example.app.R.id.action_layout_14pt) {
					layoutEm = 14;
				} else if (i == com.example.app.R.id.action_layout_15pt) {
					layoutEm = 15;
				} else if (i == com.example.app.R.id.action_layout_16pt) {
					layoutEm = 16;
				}
...
//			relayoutDocument();
	...
	protected void openDocument() {
		worker.add(new Worker.Task() {
			...
			public void run() {
				if (needsPassword)
					askPassword(com.example.app.R.string.dlog_password_message);
				else
					loadDocument();
			}
		});
	...
	protected void askPassword(int message) {
		...
		builder.setTitle(com.example.app.R.string.dlog_password_title);
		...
		worker.add(new Worker.Task() {
			...
			public void run() {
				if (passwordOkay)
					...
					askPassword(com.example.app.R.string.dlog_password_retry);
			}
		});
	}
