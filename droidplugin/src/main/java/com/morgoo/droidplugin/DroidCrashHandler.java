 ...
 */
public class DroidCrashHandler implements UncaughtExceptionHandler {
    ...
    private static final DroidCrashHandler S_DROID_CRASH_HANDLER = new DroidCrashHandler();
    ...
    public static DroidCrashHandler getInstance() {
        return S_DROID_CRASH_HANDLER;
    }
