 ...
 */
public class DroidActivityManagerService extends BaseActivityManagerService {

    private static final String TAG = DroidActivityManagerService.class.getSimpleName();
    ...
    public DroidActivityManagerService(Context hostContext) {
        super(hostContext);
