...
public class ServiceManagerCacheBinderHook extends Hook implements InvocationHandler {
        ...
        if (sCacheObj instanceof Map) {
            ...
            if (Obj != null && false) {
                ...
                if (mServiceIBinder != null) {
                    ...
                    IBinder mProxyServiceIBinder = (IBinder) DroidProxy.newProxyInstance(clazz.getClassLoader(), ifs, this);
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        try {
            ...
            if (cause != null && DroidProxy.isMethodDeclaredThrowable(method, cause)) {
                throw cause;
            } else if (cause != null) {
            ...
            if (DroidProxy.isMethodDeclaredThrowable(method, e)) {
                throw e;
            } else {
                RuntimeException runtimeException = !TextUtils.isEmpty(e.getMessage()) ? new RuntimeException(e.getMessage()) : new RuntimeException();
                runtimeException.initCause(e);
