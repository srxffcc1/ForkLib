...
//                      tarDir = tarDir.replace(pkg, String.format("%s/Plugin/%s/data/%s", mHostPkg, pkg, pkg));去掉一层插件包名
                        tarDir = tarDir.replace(pkg, String.format("%s/Plugin/%s/data/", mHostPkg, pkg));
                        return tarDir;
                    }
                }
            }
