...
public class IActivityManagerHook extends ProxyHook {
    ...
    public void onInstall(ClassLoader classLoader) throws Throwable {
        ...
        if (IActivityManagerCompat.isIActivityManager(obj)) {
            ...
            Object proxiedActivityManager = DroidProxy.newProxyInstance(objClass.getClassLoader(), ifs, this);
            ...
            Class[] ifs = interfaces != null && interfaces.size() > 0 ? interfaces.toArray(new Class[interfaces.size()]) : new Class[0];
            final Object object = DroidProxy.newProxyInstance(mOldObj.getClass().getClassLoader(), ifs, IActivityManagerHook.this);
