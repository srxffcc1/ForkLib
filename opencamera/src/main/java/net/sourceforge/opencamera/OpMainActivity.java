...
/** The opmain Activity for Open Camera.
 */
public class OpMainActivity extends Activity implements AudioListener.AudioListenerCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.opactivity_main);
		PreferenceManager.setDefaultValues(this, R.xml.oppreferences, false); // initialise any unset oppreferences to their default values
		if( OpDebug.LOG )
...
//        }
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.opmain, menu);
		return true;
	}
    ...
    void setBrightnessForCamera(boolean force_max) {
		...
		// done here rather than onCreate, so that changing it in oppreferences takes effect without restarting app
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
    ...
    /** Displays a toast with information about the current oppreferences.
