...
public class SaveLocationHistory {
	 ...
	 * @param main_activity OpMainActivity.
	 * @param pref_base String to use for shared preferences.
	 * @param folder_name The current save folder.
	 */
	SaveLocationHistory(OpMainActivity main_activity, String pref_base, String folder_name) {
		if( OpDebug.LOG )
		...
		updateFolderHistory(folder_name, false); // update_icon can be false, as updateGalleryIcon() is called later in OpMainActivity.onResume()
	 ...
	 * OpMainActivity.updateGalleryIcon().
	 */
