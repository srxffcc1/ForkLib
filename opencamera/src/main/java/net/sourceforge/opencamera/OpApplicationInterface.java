...
public class OpApplicationInterface implements ApplicationInterface {
	...
	// camera properties which are saved in bundle, but not stored in oppreferences (so will be remembered if the app goes into background, but not after restart)
