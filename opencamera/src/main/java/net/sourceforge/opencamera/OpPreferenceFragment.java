...
public class OpPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.oppreferences);
	...
	public void onResume() {
		...
		// note, setting color here only seems to affect the "opmain" preference fragment screen, and not sub-screens
	...
	/* So that manual changes to the checkbox/switch oppreferences, while the oppreferences are showing, show up;
